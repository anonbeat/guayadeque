...
namespace TagLib {
  ...
  namespace MP4 {
    ...
    public:
      /*!
       * Contructs an MP4 file from \a file.  If \a readProperties is true the
       ...
       */
      explicit File(TagLib::FileName file, bool readProperties = true, Properties::ReadStyle audioPropertiesStyle = Properties::Average);
