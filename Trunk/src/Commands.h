...
enum guCommandIds {
    ...
    ID_SONG_PLAY,
    ID_SONG_PLAYALL,
    ID_SONG_ENQUEUE_AFTER_ALL,
    ID_SONG_ENQUEUE_AFTER_TRACK,
    ID_SONG_ENQUEUE_AFTER_ALBUM,
    ID_SONG_ENQUEUE_AFTER_ARTIST,
//    ID_SONG_ENQUEUEALL_AFTER_ALL,
//    ID_SONG_ENQUEUEALL_AFTER_TRACK,
//    ID_SONG_ENQUEUEALL_AFTER_ALBUM,
//    ID_SONG_ENQUEUEALL_AFTER_ARTIST,
    ID_SONG_EDITLABELS,
    ID_SONG_EDITTRACKS,
...
//    ID_LASTFM_ENQUEUE_AFTER_ARTIST,
    ...
    ID_LASTFM_COPYTO = guEVT_USER_FIRST + 7700,
    ID_TREEVIEW_COPYTO = guEVT_USER_FIRST + 7900
};
