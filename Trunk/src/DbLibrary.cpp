...
#define GU_CURRENT_DBVERSION    "16"
...
int guDbLibrary::GetGenreId( wxString &genrename )
{
  ...
  {
    query = wxT( "SELECT song_genreid FROM songs ORDER BY song_genreid DESC LIMIT 1" );
...
//  printf( "GetArtistId\n" );
  ...
  {
    query = wxT( "SELECT song_composerid FROM songs ORDER BY song_composerid DESC LIMIT 1" );
...
//    }
  ...
  {
    query = wxT( "SELECT song_albumid FROM songs ORDER BY song_albumid DESC LIMIT 1" );
...
//TODO Add a Lock
  ...
  {
    query = wxT( "SELECT song_pathid FROM songs ORDER BY song_pathid DESC LIMIT 1" );
    dbRes = ExecuteQuery( query );
    if( dbRes.NextRow() )
    {
...
int guDbLibrary::GetArtistId( wxString &artistname, bool create )
{
  ...
  {
    query = wxT( "SELECT song_artistid FROM songs ORDER BY song_artistid DESC LIMIT 1" );
...
// -------------------------------------------------------------------------------- //
void guDbLibrary::GetRadioGenresList( const int source, const wxArrayInt &ids, guListItems * listitems, wxArrayInt * radioflags )
{
  wxString query;
  wxSQLite3ResultSet dbRes;
...
// -------------------------------------------------------------------------------- //
void guDbLibrary::GetRadioGenres( const int source, guListItems * radiogenres, bool AllowFilter, wxArrayInt * radioflags )
{
  wxString query;
  wxSQLite3ResultSet dbRes;
...
// -------------------------------------------------------------------------------- //
int guDbLibrary::AddRadioGenre( const wxString &GenreName, const int source, const int flags )
{
    wxString query;
...
// -------------------------------------------------------------------------------- //
int guDbLibrary::SetRadioGenre( const int genreid, const wxString &name, const int source, const int flags )
{
    wxString query;
...
// -------------------------------------------------------------------------------- //
void guDbLibrary::SetRadioSourceFilter( int source )
{
...
// -------------------------------------------------------------------------------- //
int guDbLibrary::DelRadioStations( int source, const wxArrayInt &radioids )
{
  wxString query;
  if( radioids.Count() )
  {
...
// -------------------------------------------------------------------------------- //
bool guDbLibrary::RadioStationExists( const int shoutcastid )
{
  wxString query;
  wxSQLite3ResultSet dbRes;
  bool RetVal;
